...
MODEL           = my_pv_system_4_ss_controller
MODULES         = my_pv_system_4_ss_controller_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE        = my_pv_system_4_ss_controller.mk
MATLAB_ROOT     = C:\Program Files (x86)\MATLAB\R2014b
ALT_MATLAB_ROOT = C:\PROGRA~2\MATLAB\R2014b
S_FUNCTIONS     = sfun_discreteVariableDelay.c send_rt.c recv_rt.c
SOLVER          = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELREFS                 = 
MODELLIB                  = my_pv_system_4_ss_controllerlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = my_pv_system_4_ss_controller_ref.rsp
MODELREF_INC_PATH        =  
