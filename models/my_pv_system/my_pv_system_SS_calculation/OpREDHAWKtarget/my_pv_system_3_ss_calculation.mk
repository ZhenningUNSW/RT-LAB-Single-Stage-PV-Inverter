...
MODEL           = my_pv_system_3_ss_calculation
MODULES         = my_pv_system_3_ss_calculation_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE        = my_pv_system_3_ss_calculation.mk
MATLAB_ROOT     = C:\Program Files (x86)\MATLAB\R2014b
ALT_MATLAB_ROOT = C:\PROGRA~2\MATLAB\R2014b
S_FUNCTIONS     = OP_SEND.c recv_rt.c sfun_discreteVariableDelay.c
SOLVER          = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELREFS                 = 
MODELLIB                  = my_pv_system_3_ss_calculationlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = my_pv_system_3_ss_calculation_ref.rsp
MODELREF_INC_PATH        =  
