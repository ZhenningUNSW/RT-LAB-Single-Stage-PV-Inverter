/*
 * my_pv_system_3_ss_calculation.h
 *
 ...
 */
#ifndef RTW_HEADER_my_pv_system_3_ss_calculation_h_
#define RTW_HEADER_my_pv_system_3_ss_calculation_h_
#include <stddef.h>
#include <string.h>
#ifndef my_pv_system_3_ss_calculation_COMMON_INCLUDES_
# define my_pv_system_3_ss_calculation_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* my_pv_system_3_ss_calculation_COMMON_INCLUDES_ */

#include "my_pv_system_3_ss_calculation_types.h"
...
#define my_pv_system_3_ss_calculation_rtModel RT_MODEL_my_pv_system_3_ss_calculation_T
...
typedef struct {
  ...
  real_T DigitalClock_h;               /* '<S10>/Digital  Clock' */
  real_T Integ4_b;                     /* '<S10>/Integ4' */
  real_T K1_i;                         /* '<S10>/K1' */
  real_T SFunction_f;                  /* '<S11>/S-Function' */
  ...
  real_T Sum7;                         /* '<S10>/Sum7' */
  real_T Mean;                         /* '<S10>/Product' */
  real_T Sum5;                         /* '<S10>/Sum5' */
  real_T Gain1_m;                      /* '<S8>/Gain1' */
  real_T Gain_a;                       /* '<S8>/Gain' */
  real_T Correction_e;                 /* '<S8>/Sum1' */
  real_T Sum7_g;                       /* '<S8>/Sum7' */
  real_T Mean_n;                       /* '<S8>/Product' */
  real_T Sum5_p;                       /* '<S8>/Sum5' */
  boolean_T RelationalOperator;        /* '<S8>/Relational Operator' */
  boolean_T RelationalOperator_n;      /* '<S10>/Relational Operator' */
} B_my_pv_system_3_ss_calculation_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T Integ4_DSTATE;                /* '<S8>/Integ4' */
  real_T UnitDelay_DSTATE;             /* '<S8>/Unit Delay' */
  real_T UnitDelay1_DSTATE;            /* '<S8>/Unit Delay1' */
  real_T Integ4_DSTATE_e;              /* '<S10>/Integ4' */
  ...
  void *SFunction_PWORK_o;             /* '<S9>/S-Function' */
  void *SFunction_PWORK_k;             /* '<S11>/S-Function' */
  int_T SFunction_IWORK[5];            /* '<S13>/S-Function' */
  int_T SFunction_IWORK_f;             /* '<S9>/S-Function' */
  int_T SFunction_IWORK_n;             /* '<S11>/S-Function' */
  uint8_T Integ4_SYSTEM_ENABLE;        /* '<S8>/Integ4' */
  uint8_T Integ4_SYSTEM_ENABLE_f;      /* '<S10>/Integ4' */
} DW_my_pv_system_3_ss_calculation_T;

/* Backward compatible GRT Identifiers */
#define rtB                            my_pv_system_3_ss_calculation_B
#define BlockIO                        B_my_pv_system_3_ss_calculation_T
#define rtP                            my_pv_system_3_ss_calculation_P
#define Parameters                     P_my_pv_system_3_ss_calculation_T
#define rtDWork                        my_pv_system_3_ss_calculation_DW
#define D_Work                         DW_my_pv_system_3_ss_calculation_T

/* Parameters (auto storage) */
struct P_my_pv_system_3_ss_calculation_T_ {
  ...
  real_T Gain1_Gain_o;                 /* Expression: sps.K2
                                        ...
                                        */
  real_T Gain_Gain_o;                  /* Expression: sps.K1
  ...
  real_T SFunction_P2_Size[2];         /* Computed Parameter: SFunction_P2_Size
                                        * Referenced by: '<S14>/S-Function'
                                        */
  real_T SFunction_P2;                 /* Expression: Data_width
                                        * Referenced by: '<S14>/S-Function'
                                        */
...
struct tag_RTM_my_pv_system_3_ss_calculation_T {
  const char_T *path;
...
extern P_my_pv_system_3_ss_calculation_T my_pv_system_3_ss_calculation_P;

/* Block signals (auto storage) */
extern B_my_pv_system_3_ss_calculation_T my_pv_system_3_ss_calculation_B;

/* Block states (auto storage) */
extern DW_my_pv_system_3_ss_calculation_T my_pv_system_3_ss_calculation_DW;

/*====================*
 * External functions *
 *====================*/
extern my_pv_system_3_ss_calculation_rtModel *my_pv_system_3_ss_calculation(void);
...
extern RT_MODEL_my_pv_system_3_ss_calculation_T *const
 ...
 *
 * '<Root>' : 'my_pv_system_3_ss_calculation'
 * '<S1>'   : 'my_pv_system_3_ss_calculation/OpCCode_do_not_touch'
 * '<S2>'   : 'my_pv_system_3_ss_calculation/SS_calculation'
 * '<S3>'   : 'my_pv_system_3_ss_calculation/powergui'
 * '<S4>'   : 'my_pv_system_3_ss_calculation/SS_calculation/Mean'
 * '<S5>'   : 'my_pv_system_3_ss_calculation/SS_calculation/Mean1'
 * '<S6>'   : 'my_pv_system_3_ss_calculation/SS_calculation/rtlab_send_subsystem'
 * '<S7>'   : 'my_pv_system_3_ss_calculation/SS_calculation/zzzOpComm'
 * '<S8>'   : 'my_pv_system_3_ss_calculation/SS_calculation/Mean/Model'
 * '<S9>'   : 'my_pv_system_3_ss_calculation/SS_calculation/Mean/Model/Discrete Variable Time Delay'
 * '<S10>'  : 'my_pv_system_3_ss_calculation/SS_calculation/Mean1/Model'
 * '<S11>'  : 'my_pv_system_3_ss_calculation/SS_calculation/Mean1/Model/Discrete Variable Time Delay'
 * '<S12>'  : 'my_pv_system_3_ss_calculation/SS_calculation/rtlab_send_subsystem/Subsystem1'
 * '<S13>'  : 'my_pv_system_3_ss_calculation/SS_calculation/rtlab_send_subsystem/Subsystem1/Send1'
 * '<S14>'  : 'my_pv_system_3_ss_calculation/SS_calculation/zzzOpComm/Receive_1'
 * '<S15>'  : 'my_pv_system_3_ss_calculation/SS_calculation/zzzOpComm/busStruct'
 * '<S16>'  : 'my_pv_system_3_ss_calculation/SS_calculation/zzzOpComm/busStruct/Sub1'
 */
#endif                                 /* RTW_HEADER_my_pv_system_3_ss_calculation_h_ */
