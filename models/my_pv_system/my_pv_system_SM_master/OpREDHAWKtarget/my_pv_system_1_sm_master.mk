...
MODEL           = my_pv_system_1_sm_master
MODULES         = my_pv_system_1_sm_master_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE        = my_pv_system_1_sm_master.mk
MATLAB_ROOT     = C:\Program Files (x86)\MATLAB\R2014b
ALT_MATLAB_ROOT = C:\PROGRA~2\MATLAB\R2014b
S_FUNCTIONS     = send_rt.c OP_SEND.c opmonitor.c recv_rt.c fts5abcd_noncomp.c RECV_Param.c
SOLVER          = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 2
...
MODELREFS                 = 
MODELLIB                  = my_pv_system_1_sm_masterlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = my_pv_system_1_sm_master_ref.rsp
MODELREF_INC_PATH        =  
